  ...
  return (
    <div className="grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
      <main className="row-start-2 flex flex-col items-center gap-8 sm:items-start">
        ...
        <div className="flex gap-2 rounded-lg bg-gray-200 p-4 shadow-md dark:bg-gray-700">
          <button onClick={handleAlert} className="bg-blue-500 text-white" disabled>
            Disabled
          </button>

          <button onClick={handleAlert} className="bg-blue-500 text-white">
            Alert
          </button>
